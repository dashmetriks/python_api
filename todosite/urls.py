...
urlpatterns = patterns('',
    ...
    url(r'^mygameweek/$', views.MyGameUsersView.as_view()),
   ...
   # url(r'^emailcheck/(?P<email>[\w.%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,4}+)$', views.EmailCheckView.as_view()),
    ...
    url(r'^resetpassword/(?P<email>[_%&+0-9a-zA-Z ]+@[_%&+0-9a-zA-Z ]+\.[_%&+0-9a-zA-Z ]+)$', views.ResetPassword.as_view()),
    url(r'^password-reset/confirm/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$', views.ResetPasswordConfirm.as_view()),
